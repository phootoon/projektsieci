...
int MainWindow::onClientButtonClicked(){
    int argc = 1;
    char* dummy_argv[] = { (char*)"cw", nullptr };
    char** argv = dummy_argv;
    QApplication cw(argc, argv);
...
int MainWindow::onServerButtonClicked(){
    int argc = 1;
    char* dummy_argv[] = { (char*)"sw", nullptr };
    char** argv = dummy_argv;
    QApplication sw(argc, argv);
